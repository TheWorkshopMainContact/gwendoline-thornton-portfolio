...
![index.html code check through validator](/assets/images/about-w3c-html-check-one.png)

Testing about.html code through the W3C validator second check. No errors found.
![index.html code check through validator](/assets/images/about-w3c-html-check-two.png)
